...
class BigquerySMSSentUsers(Insertor):
    _PROJECT_NAME = 'remarketing-mail'
    _SLEEP_SECONDS = 2

    def __init__(self, client_name: str, table_name: str = 'sms_history') -> None:
        """_summary_

        Args:
            client_name (str): _description_
            table_name (str, optional): _description_. Defaults to 'sms_history'.
